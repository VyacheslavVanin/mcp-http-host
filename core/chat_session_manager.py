...
It is crucial to proceed step-by-step, waiting for the tool's message after each tool use before moving forward with the task. This approach allows you to:
...
Never reply with empty responses; this is not informative. Write about what you are waiting for in this case.

...
class TestChatSessionStreaming:
    ...
    def test_user_request_stream_basic(self, chat_session_streaming):
        ...
        chat_session_streaming.toolbox.get_tools_descriptions.return_value = "Test tools"
    ...
    def test_user_request_stream_with_context(self, chat_session_streaming):
        ...
        response = chat_session_streaming.user_request_stream("Hello!", system_context="Current file: test.py")
